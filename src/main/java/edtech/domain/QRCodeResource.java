 ...
 * A QRCodeResource.
 */
@Table("qr_code_resource")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class QRCodeResource implements Serializable {
    ...
    public QRCodeResource id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public QRCodeResource type(DocumentResourceType type) {
        this.setType(type);
        return this;
    }
    ...
    public QRCodeResource uri(String uri) {
        this.setUri(uri);
        return this;
    }
    ...
    public QRCodeResource data(String data) {
        this.setData(data);
        return this;
    }
    ...
    public QRCodeResource asciidocSlide(AsciidocSlide asciidocSlide) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QRCodeResource)) {
            return false;
        }
        return getId() != null && getId().equals(((QRCodeResource) o).getId());
    }
