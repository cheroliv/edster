...
export const PresentationUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...presentationEntity,
          user: presentationEntity?.user?.id,
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('edsterApp.presentation.name')}
              ...
              <ValidatedField
                ...
                type="text"
              />
              <ValidatedField label={translate('edsterApp.presentation.uri')} id="presentation-uri" name="uri" data-cy="uri" type="text" />
              <ValidatedField
                id="presentation-user"
                name="user"
                data-cy="user"
                label={translate('edsterApp.presentation.user')}
                type="select"
                required
              >
                <option value="" key="0" />
