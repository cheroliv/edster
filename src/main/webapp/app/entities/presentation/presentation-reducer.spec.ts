...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESENTATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRESENTATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRESENTATION actions', async () => {
      const arg = { id: 29280 };
    ...
    it('dispatches UPDATE_PRESENTATION actions', async () => {
      const arg = { id: 29280 };
    ...
    it('dispatches PARTIAL_UPDATE_PRESENTATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRESENTATION actions', async () => {
      const arg = 42666;
