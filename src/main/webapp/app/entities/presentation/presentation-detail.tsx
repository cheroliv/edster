    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="edsterApp.presentation.user">User</Translate>
          </dt>
          <dd>{presentationEntity.user ? presentationEntity.user.login : ''}</dd>
        </dl>
