...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASCIIDOCSLIDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASCIIDOCSLIDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASCIIDOCSLIDE actions', async () => {
      const arg = { id: 22167 };
    ...
    it('dispatches UPDATE_ASCIIDOCSLIDE actions', async () => {
      const arg = { id: 22167 };
    ...
    it('dispatches PARTIAL_UPDATE_ASCIIDOCSLIDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASCIIDOCSLIDE actions', async () => {
      const arg = 42666;
