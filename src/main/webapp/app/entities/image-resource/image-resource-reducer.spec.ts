...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGERESOURCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IMAGERESOURCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IMAGERESOURCE actions', async () => {
      const arg = { id: 1291 };
    ...
    it('dispatches UPDATE_IMAGERESOURCE actions', async () => {
      const arg = { id: 1291 };
    ...
    it('dispatches PARTIAL_UPDATE_IMAGERESOURCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IMAGERESOURCE actions', async () => {
      const arg = 42666;
