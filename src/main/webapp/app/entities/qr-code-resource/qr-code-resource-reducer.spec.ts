...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QRCODERESOURCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QRCODERESOURCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QRCODERESOURCE actions', async () => {
      const arg = { id: 25199 };
    ...
    it('dispatches UPDATE_QRCODERESOURCE actions', async () => {
      const arg = { id: 25199 };
    ...
    it('dispatches PARTIAL_UPDATE_QRCODERESOURCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QRCODERESOURCE actions', async () => {
      const arg = 42666;
