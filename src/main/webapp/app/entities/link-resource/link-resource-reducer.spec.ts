...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINKRESOURCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LINKRESOURCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LINKRESOURCE actions', async () => {
      const arg = { id: 7523 };
    ...
    it('dispatches UPDATE_LINKRESOURCE actions', async () => {
      const arg = { id: 7523 };
    ...
    it('dispatches PARTIAL_UPDATE_LINKRESOURCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LINKRESOURCE actions', async () => {
      const arg = 42666;
