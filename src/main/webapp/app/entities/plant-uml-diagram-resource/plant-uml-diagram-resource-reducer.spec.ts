...
import reducer, {
  ...
  reset,
  updateEntity,
} from './plant-uml-diagram-resource.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANTUMLDIAGRAMRESOURCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PLANTUMLDIAGRAMRESOURCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PLANTUMLDIAGRAMRESOURCE actions', async () => {
      const arg = { id: 1497 };
    ...
    it('dispatches UPDATE_PLANTUMLDIAGRAMRESOURCE actions', async () => {
      const arg = { id: 1497 };
    ...
    it('dispatches PARTIAL_UPDATE_PLANTUMLDIAGRAMRESOURCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PLANTUMLDIAGRAMRESOURCE actions', async () => {
      const arg = 42666;
