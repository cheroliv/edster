package education.cccp.edtech.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("education.cccp.edtech.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("education.cccp.edtech.security.DomainUserDetailsService", "createSpringSecurityUser");
